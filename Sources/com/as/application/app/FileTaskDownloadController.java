...
import com.as.application.ui.components.DownloadIsCompletePage;
...
public class FileTaskDownloadController extends ERXNextPageForResultWOAction {
	...
	public WOActionResults performAction() {
		if (_result instanceof File) {
			...
			dl.setDownloadFilename(downloadFileNameForProject());
	/*
	 * 
...
DownloadIsCompletePage nextPage = (DownloadIsCompletePage)  D2W.factory().pageForConfigurationNamed("DownloadIsCompletePage", session());
	...
	private String _downloadFileNameForProject;
	
	/** @return what */
	public String downloadFileNameForProject() {
		return _downloadFileNameForProject;
	}
	
	/** @param downloadFileNameForClient what */
	public void setDownloadFileNameForProject(String downloadFileNameForProject){
		_downloadFileNameForProject = downloadFileNameForProject;
	}
