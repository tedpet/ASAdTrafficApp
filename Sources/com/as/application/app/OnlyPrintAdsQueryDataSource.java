...
public class OnlyPrintAdsQueryDataSource implements ERDQueryDataSourceDelegateInterface {
...
//    EOQualifier q = sender.qualifier();
    ...
    EOQualifier q = ERXQ.and(ERXQ.equals("isBillboard", false).and(ERXQ.equals("isDigital", false)), sender.qualifier());
